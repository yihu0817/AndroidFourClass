...
public class HttpExampleActivity extends Activity {
	 ...
	 * 
	 */
	public void onConnectionClickHandler(View view) throws UnsupportedEncodingException {
		String stringUrl = mUrlText.getText().toString();// 获取请求的URL从EditText控件中.
		ConnectivityManager connMgr = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
		NetworkInfo networkInfo = connMgr.getActiveNetworkInfo();
		if (networkInfo != null && networkInfo.isConnected()) {
			
			String parameter = "?userName="+URLEncoder.encode("张三","UTF-8")+"&passWord=123456";
