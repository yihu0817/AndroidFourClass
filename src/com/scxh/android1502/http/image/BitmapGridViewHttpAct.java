...
public class BitmapGridViewHttpAct extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		exec = new ThreadPoolExecutor(15, 150, 10, TimeUnit.SECONDS,
	...
	public class MyGirdViewAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			// if(result != null){
			// holderView.iconImageView.setImageBitmap(result);
			// }
			//
			// }
	...
	public void loadBitmap(String imageUrl, ImageView imageView, int res,
		...
		if (cancelPotentialWork(imageUrl, imageView)) {
			...
			task.executeOnExecutor(exec, imageUrl, String.valueOf(width),
	...
	class BitmapWorkerTask extends AsyncTask<String, Void, Bitmap> {
		...
		protected Bitmap doInBackground(String... params) {
			...
			return decodeSampledBitmapFromStream(getResources(), data, widht,
					height);
		}
