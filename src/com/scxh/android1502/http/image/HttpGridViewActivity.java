...
import com.scxh.android1502.http.image.BitmapGridViewHttpAct.AsyncDrawable;
import com.scxh.android1502.http.image.BitmapGridViewHttpAct.BitmapWorkerTask;
import com.scxh.android1502.ui.gridview.GridViewActivity.MyGridViewAdapter;
...
public class HttpGridViewActivity extends Activity {
	private int[] arrays = { R.drawable.list1, R.drawable.list2,
			R.drawable.list3, R.drawable.list4, R.drawable.list1,
			R.drawable.list2, R.drawable.list3, R.drawable.list1,
			R.drawable.list2 };
