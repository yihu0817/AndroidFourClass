...
public class HttpGridViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAsyncLoaderImage = AsyncLoaderImage.getInstanceAsyncLoaderImage();
		mAsyncLoaderImage.setThreadPoolExecutor(10,100);
	...
	public class MyGridViewAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			mAsyncLoaderImage.loadBitmap(getResources(),itemUrl,contentImg);
