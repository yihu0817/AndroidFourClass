...
public class MyPreferenceContentProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		String name = mSharedPreferences.getString(DataColumn.Student.COLUMN_NAME_NAME, "");
		String password = mSharedPreferences.getString(DataColumn.Student.COLUMN_NAME_NUMBER, "");
		String id = "1";
