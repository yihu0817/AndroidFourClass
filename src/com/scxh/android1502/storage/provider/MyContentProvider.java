...
import com.scxh.android1502.storage.db.DatabaseHelper;
/**
...
public class MyContentProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection,String[] selectionArgs, String sortOrder) {
		Cursor cursor = mSQLiteDatabase.query(DataColumn.Student.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
		return cursor;
	}

	@Override
	public Uri insert(Uri uri, ContentValues values) {
		mSQLiteDatabase.insert(DataColumn.Student.TABLE_NAME, null, values);
		return null;
	}

	@Override
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		mSQLiteDatabase.delete(DataColumn.Student.TABLE_NAME, selection, selectionArgs);
		return 0;
	}

	@Override
	public int update(Uri uri, ContentValues values, String selection,String[] selectionArgs) {
		mSQLiteDatabase.update(DataColumn.Student.TABLE_NAME, values, selection, selectionArgs);
		return 0;
	}
	@Override
