package com.scxh.android1502.animation;
...
public class Animation1Activity extends Activity {
	...
	private Button multipleButtonXMLButton = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		multipleButtonXMLButton = (Button) findViewById(R.id.multipleButton);
		...
		// XML
		 multipleButtonXMLButton.setOnClickListener(new DoubleeaniButtonXMLListener());
	...
	class DoubleeaniButtonXMLListener implements OnClickListener {
		public void onClick(View v) {
			Animation animation = AnimationUtils.loadAnimation(
					Animation1Activity.this, R.anim.doubleani);// 淡入淡出与移动动画结合
			// 启动动画
	...
	class AlphaButtonXMLListener implements OnClickListener {
		public void onClick(View v) {
			Animation animation = AnimationUtils.loadAnimation(
					Animation1Activity.this, R.anim.alpha_anim);
			// 启动动画
			image.startAnimation(animation);
		}
	}
